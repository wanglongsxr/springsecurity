...
import com.example.boot_securtiy.authorize.AuthorizeSecurityInterceptor;
...
//                .successForwardUrl("/login-success")//登录成功后跳转页
                ...
                .logout()
                .logoutUrl("/logout");
        http.addFilterAfter(authorizeSecurityInterceptor, FilterSecurityInterceptor.class);
    }
}
